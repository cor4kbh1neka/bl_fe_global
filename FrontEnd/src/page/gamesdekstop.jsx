...
export const GamesdekstopPage = () => {
    ...
    const dataGames = {
        sportsbobet: "/prx/authlog",
        sport568win: "/prx/authlog/winsprt",
        virtual568win: "/prx/authlog/vrsprt",
        livecasino568win: "/prx/authlog/csn",
        virtualcasinoroyal: "/prx/authlog/gms",
        slotgames: "/prx/authlog/slsgms",
    }
    ...
    useEffect(() => {
        ...
        const fetchDataIframe = async () => {
          ...
          try {
            const response = await fetch(dataGames[namegames], {
              method: "POST",
              headers: {
...
export default GamesdekstopPage;
