...
const ReferralLobbyPage = () => {
  ...
  return (
    <div className="container daftarddref">
      {dataProvide ? (
        <MetaTags
      ...
      <Lobbynavbar pageTitle="daftarkan referral" />
      <div className="secregister">
        <form onSubmit={handleSubmit} action="" id="daftar" name="daftar">
          ...
          <div className="daftarbutton isireff">
            <button
              type="submit"
              id="submitregister"
              name="submitregister"
            ...
            <Link to="/referral" className="tombol border">Kembali</Link>
          </div>
        </form>
      </div>
      <Footer />
...
export default ReferralLobbyPage;
